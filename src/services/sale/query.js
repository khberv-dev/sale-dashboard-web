...
export const useGetSaleStatsQuery = (byTeam = false, startDate = null, endDate = null) => useQuery({
    queryKey: ['sale-stats', byTeam, startDate, endDate],
    queryFn: () => getSaleStats(byTeam, startDate, endDate)
})
